...
- (void)setupUI
{
    ...
    banner.frame = CGRectMake(25, 55, MAIN_SCREEN_WIDTH - 50, (MAIN_SCREEN_WIDTH - 50) * 0.3331);
    self.banner = banner;
    ...
    title.preferredMaxLayoutWidth = (MAIN_SCREEN_WIDTH - 50.0);
    ...
    [title mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self.contentView.mas_top).with.offset(70 + (MAIN_SCREEN_WIDTH - 50) * 0.3331);
        make.right.mas_equalTo(self.contentView.mas_right).with.offset(-25.0);
    }];
    ...
    articleDes.preferredMaxLayoutWidth = (MAIN_SCREEN_WIDTH - 50.0);
    ...
    articleDes.textColor = RGB(170, 170, 170);
    ...
    comments.textColor = RGB(107, 107, 107);
    ...
    timeLabel.textColor = RGB(208, 208, 208);
...
- (void)setModel:(NewsModel *)model
{
    ...
    if((float)model.summary.length/MAIN_SCREEN_WIDTH > 0.11)
    {
        NSString *temStr = [model.summary substringToIndex:(int)(MAIN_SCREEN_WIDTH * 0.11)];
